...
class Pipsolar : public uart::UARTDevice, public PollingComponent {
  // P005GS values
  PIPSOLAR_SENSOR(grid_voltage, 0P005GS, int)
  PIPSOLAR_SENSOR(grid_frequency, 0P005GS, int)
  PIPSOLAR_SENSOR(ac_output_voltage, 0P005GS, int)
  PIPSOLAR_SENSOR(ac_output_frequency, 0P005GS, int)
  ...
  PIPSOLAR_SENSOR(battery_voltage, 0P005GS, int)
  PIPSOLAR_SENSOR(battery_voltage_from_scc, 0P005GS, int)
  PIPSOLAR_SENSOR(battery_voltage_from_scc2, 0P005GS, int)
  ...
  PIPSOLAR_SENSOR(pv1_input_voltage, 0P005GS, int)
  PIPSOLAR_SENSOR(pv2_input_voltage, 0P005GS, int)
  PIPSOLAR_SENSOR(setting_value_configuration_state, 0P005GS, int)
  PIPSOLAR_SENSOR(mppt1_charger_status, 0P005GS, int)
  PIPSOLAR_SENSOR(mppt2_charger_status, 0P005GS, int)
  PIPSOLAR_SENSOR(load_connection, 0P005GS, int)
  PIPSOLAR_SENSOR(battery_power_direction, 0P005GS, int)
  PIPSOLAR_SENSOR(dc_ac_power_direction, 0P005GS, int)
  PIPSOLAR_SENSOR(line_power_direction, 0P005GS, int)
  PIPSOLAR_SENSOR(local_parallel_id, 0P005GS, int)

  //0P007PIRI values
  PIPSOLAR_SENSOR(ac_input_rating_voltage,0P007PIRI, int)
  PIPSOLAR_SENSOR(ac_input_rating_current,0P007PIRI, int)
  PIPSOLAR_SENSOR(ac_output_rating_voltage,0P007PIRI, int)
  PIPSOLAR_SENSOR(ac_output_rating_frequency,0P007PIRI, int)
  PIPSOLAR_SENSOR(ac_output_rating_current,0P007PIRI, int)
  PIPSOLAR_SENSOR(ac_output_rating_apparent_power,0P007PIRI, int)
  PIPSOLAR_SENSOR(ac_output_rating_active_power,0P007PIRI, int)
  PIPSOLAR_SENSOR(battery_rating_voltage,0P007PIRI, int)
  PIPSOLAR_SENSOR(battery_recharge_voltage,0P007PIRI, int)
  PIPSOLAR_SENSOR(battery_redischarge_voltage,0P007PIRI, int)
  PIPSOLAR_SENSOR(battery_under_voltage,0P007PIRI, int)
  PIPSOLAR_SENSOR(battery_bulk_voltage,0P007PIRI, int)
  PIPSOLAR_SENSOR(battery_float_voltage,0P007PIRI, int)
  PIPSOLAR_SENSOR(battery_type,0P007PIRI, int)
  PIPSOLAR_SENSOR(max_ac_charging_current,0P007PIRI, int)
  PIPSOLAR_SENSOR(max_charging_current,0P007PIRI, int)
  ...
  PIPSOLAR_SENSOR(output_model_setting,0P007PIRI, int)
  PIPSOLAR_SENSOR(solar_power_priority,0P007PIRI, int)
